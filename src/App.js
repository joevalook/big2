...
function App() {
  ...
  return (
    <div className={'App ' + (doubleUp ? 'red ' : ' ') + (darkMode ? 'black ' : 'white ')}>
      ...
      {(screen === 4) && <PokerRules setPokerNumber={setPokerNumber} setStartingAmount={setPokerStartingAmount} setScreen= {setScreen} setPlayerNames={setPlayerNames} pokerNumber={pokerNumber}/>}
